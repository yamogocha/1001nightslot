...
displayIdleScreen = function() {
	...
	document.getElementById("top-button").className = 'install-idle-dl2';
...
var clickDownload = function() {
	if (typeof mnUserClickDownload != 'undefined') {
		...
		window.location.href = 'https://itunes.apple.com/us/app/slots-vegas-party!-play-free/id928142396?mt=8';
	}
}
/********** OUTRO SPECIFIC JAVASCRIPT **********/